# Graph Report - Wiki  (2026-07-02)

## Corpus Check
- 43 files · ~57,037 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 306 nodes · 354 edges · 36 communities (34 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `020c9930`
...
8. `골목길: 귀흔` - 6 edges
9. `checkPublicContent()` - 5 edges
10. `parseArgs()` - 5 edges
...
Cohesion: 0.06
Nodes (35): gitDirtyFor(), args, clonePath, cloneProtocol, commitCount, computeRange(), detectOwner(), ensureClone() (+27 more)
...
Cohesion: 0.22
Nodes (15): collectCommitDetails(), allowedAssetExtensions, blockedPatterns, canRunTesseract(), checkPublicContent(), extractAssetLinks(), hasBlockedText(), hasExifMarker() (+7 more)
...
Cohesion: 0.17
Nodes (10): argv, blockedPatterns, failures, parsed, publishRoot, relative, requiredMemoryFields, root (+2 more)
...
## Knowledge Gaps
- **159 isolated node(s):** `argv`, `root`, `publishRoot`, `strictMemory`, `root` (+154 more)
...
- **Why does `toRelativePortable()` connect `Community 0` to `Community 1`, `Community 4`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `parseArgs()` connect `Community 0` to `Community 1`, `Community 4`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `slugify()` connect `Community 0` to `Community 1`, `Community 4`?**
