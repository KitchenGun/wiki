# Graph Report - Wiki  (2026-07-03)

## Corpus Check
- 46 files · ~75,625 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 398 nodes · 474 edges · 40 communities (38 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb045e49`
...
## Knowledge Gaps
- **219 isolated node(s):** `argv`, `root`, `publishRoot`, `strictMemory`, `root` (+214 more)
...
- **Why does `toRelativePortable()` connect `Community 8` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 11`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `parseArgs()` connect `Community 8` to `Community 0`, `Community 1`, `Community 6`, `Community 7`, `Community 11`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `recommendMemoryAction()` connect `Community 0` to `Community 16`, `Community 1`, `Community 5`?**
