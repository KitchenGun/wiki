...
플레이어가 직접 만지는 AI, UI, 옵션, 인벤토리 시스템을 Unreal Engine으로 구현하고, 현지화·Steamworks·빌드 운영까지 연결해 온 클라이언트 프로그래머입니다. 이 노트에는 출시 프로젝트와 개인 R&D에서 실제로 선택한 구조, 검증한 범위, 남겨 둔 경계를 기록합니다. [[engineering-persona]]
