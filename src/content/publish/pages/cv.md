...
**개발팀 / 사원 / 클라이언트 프로그래머 (Unreal), 정규직** / 2023.04 ~ 2026.05 (약 3년 1개월, 권고사직)

담당:

- **골목길: 귀흔** (PC/STOVE, 출시 2025.10.29, Smilegate 배급, 참여 2024.04.09~2026.05.01): 챌린지 모드, 핵심 퍼즐 로직, Behavior Tree·Blackboard·AI Perception·EQS 기반 AI, Common UI 기반 UI·포커스 관리, 인벤토리, Custom GameUserSettings, DLSS/FSR, 사운드 옵션, 로컬라이제이션, MetaSound, Sequencer, 콘텐츠 기획·개발
- **Forbidden Art** (PC VR/Steam/STOVE, Steam 출시 2024.03.25, 참여 2023.04.15~2024.05.02): 핵심 퍼즐 로직, 입력, 인벤토리, Steam 도전과제, Depot 관리, 빌드 업데이트·업로드, AI, 로컬라이제이션, 사운드 옵션
...
- 타르코프 스타일 인벤토리 시스템 개발
- Unreal Data Asset과 DataTable 기반 아이템 데이터 테이블 제작
