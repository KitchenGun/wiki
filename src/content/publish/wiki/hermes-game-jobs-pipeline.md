...
Hermes Game Jobs Pipeline은 공개 게임 채용 공고를 수집해 정규화된 행으로 저장하고, 공개 경력 프로필과 대조해 사람이 검토할 후보와 근거를 정리하는 자동화다.
...
![Hermes game job raw data sheet](./assets/hermes-game-jobs-sheet-public.webp)

_공개용 이미지는 원본 행의 공고 ID, 출처, 회사명, 공고명, 기술, 지역, 마감일, URL을 가린 예시다._
...
![Hermes game job weekly matching report](./assets/hermes-game-jobs-discord-public.webp)

_공개용 이미지는 회사, 공고명, 점수, 경력 수치, 매칭 근거, 날짜를 제거하고 처리 흐름만 남겼다._
...
- 프로필의 세부 경력 수치나 원본 공고 행은 공개 문서와 이미지에서 제외한다.
